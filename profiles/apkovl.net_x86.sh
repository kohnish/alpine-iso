...
makefile root:root 0655 "$tmp"/etc/profile.d/net_x86_common.sh <<"EOF"
#/bin/sh
if [[ $USER == "root" ]]; then
    export LBU_MEDIA=sda1
    export TMPDIR=/mnt
...
/dev/sda1 /media/sda1 vfat ro,noatime,fmask=0022,dmask=0022,codepage=437,iocharset=ascii,shortname=mixed,errors=remount-ro 0 0
/dev/sda2 /mnt ext4 rw,noatime,nofail 0 0
EOF
